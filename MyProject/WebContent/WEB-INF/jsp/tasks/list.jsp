	...
	<table cellspacing="5" class="main-table wide">
		...
		<c:forEach items="${tasks}" var="task">
			<tr>
				...
				<td><a href="managers/${task.manager.id}">${task.manager.name}</a></td>
				<td><c:forEach items="${task.assignedEmployees}" var="emp">
				...
				<td><a href="tasks/${task.id}">Go to page</a></td>
				<td><sf:form action="tasks/${task.id}" method="delete" cssClass="delete">

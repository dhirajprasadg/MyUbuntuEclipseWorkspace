	...
	<div id="list">
		<ul>
			<li><label for="description">Description:</label> 
			  <input name="description" id="description" value="${task.description}" disabled="${task.completed ? 'disabled' : ''}" /></li>
			<li><label for="manager">Manager:</label>
			  <input name="manager" id="manager" value="${task.manager.name}" disabled="true" /></li>
			<li><label for="employees">Employees:</label>

...
<body>
	...
	<div id="list">
		<h3>Busiest task</h3>
		<ul>
			<li><a href="/MyProject/tasks/${busiestTask.id}" id="busiest-task">${busiestTask.description}</a></li>
		</ul>
	...
	<a href="/MyProject/welcome">Go Back</a>
	...
	<script type="text/javascript">
		(function() {
			...
			$("#select-managers").on("change",
					function() {
						setAddAction("#select-managers", "#manager-form","manager-tasks");
					});
			
			$("#select-employees").on("change",
					function() {
						setAddAction("#select-employees", "#employee-form","employee-tasks");
					});
			...
			function setAddAction(selectName, formName, action) {
				...
				$(formName).attr("action","/MyProject/timesheet-service/" + action + "/" + id);
			}
		})();
	</script>
</body>

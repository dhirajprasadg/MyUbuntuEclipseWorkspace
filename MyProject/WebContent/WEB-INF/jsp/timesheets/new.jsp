...
<body>
	...
	<div id="list">
		<sf:form method="post" action="timesheets" commandName="timesheet">
			<ul>
				<li><label for="employees">Pick employee:</label> <sf:select path="who" id="employees">
						<sf:options items="${employees}" itemLabel="name" itemValue="id" />
					</sf:select></li>
				<li><label for="tasks">Pick task:</label> <sf:select path="task" id="tasks">
						<sf:options items="${tasks}" itemLabel="description" itemValue="id" />
					</sf:select></li>
				<li><label for="hours">Hours:</label> <sf:input path="hours" /></li>

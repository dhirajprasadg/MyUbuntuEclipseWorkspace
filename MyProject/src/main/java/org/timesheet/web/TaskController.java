...
public class TaskController {
	 ...
	 * 
	 * @param e
	 *            Thrown exception with task that couldn't be deleted
	...
	public String addEmployee(
	    ...
	    log.debug("find employee started");
	    Employee employee = employeeDao.find(employeeId);
	    log.debug("find employee finished");
	    log.debug("find task started");
	    Task task = taskDao.find(taskId);
	    log.debug("find task finished");
